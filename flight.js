...
let dest = 'HND'; //Three Letter Destination Name. Here, Haneda airport in japan
const getFlightRates = (weeks, res, maxDays = 70, fromMin = '2023-07-01', selectedDate = '2023-06-29', dest = dest) => {
// console.log(res);
// return;
  ...
  let jfkToDestBody = `[null,"[null,[null,null,1,null,[],1,[1,0,0,0],null,null,null,null,null,null,[[[[[\\"/m/02_286\\",4]]],[[[\\"${dest}\\",0]]],null,0,[],[],\\"${selectedDate}\\",null,[],[],[],null,null,[],3],[[[[\\"${dest}\\",0]]],[[[\\"/m/02_286\\",4]]],null,0,[],[],\\"2023-07-29\\",null,[],[],[],null,null,[],3]],null,null,null,true,null,null,null,null,null,[],null,null,null],[\\"${fromMin}\\",\\"${fromMax}\\"],[\\"${toMin}\\",\\"${toMax}\\"]]"]&at=ADrsKaGvGdj45shP2ktHAZ4ZWSiC:${(new Date()).getTime()}&`;
  jfkToDestBody = 'f.req='+encodeURIComponent(jfkToDestBody);
  const options = {
